...
function SideBar() {
  ...
  return (
    <nav className="row-start-1 row-end-3 flex flex-col justify-between border-r-1 border-r-gray-300/30 bg-gray-100/20 px-4 pt-10 pb-8 font-semibold dark:border-r-gray-500/30 dark:bg-gray-950/20">
