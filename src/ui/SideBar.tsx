...
function SideBar() {
  ...
  return (
    <nav
      ...
      className={`row-start-1 row-end-3 flex transition-all duration-300 ${!isExpanded ? "w-[16rem]" : "w-[5rem]"} flex-col justify-between border-r-1 border-r-gray-300/30 bg-gray-100/20 p-4 pt-6 font-semibold dark:border-r-gray-500/30 dark:bg-gray-950/20`}
    >
