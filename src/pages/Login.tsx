...
function Login() {
  ...
  return (
    ...
    >
      <LoginContainer />
      <div className="relative z-20 flex h-full flex-3/5 items-center justify-center rounded-bl-[4rem] border-l-1 border-l-indigo-200/20 bg-indigo-100 dark:border-l-indigo-800/20 dark:bg-gray-600">
        <img
          src={loginPhoto}
