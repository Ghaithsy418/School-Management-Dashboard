...
function HowToUse() {
  return (
    <div className="flex flex-col items-start justify-center gap-4 rounded-xl border border-gray-200 bg-white px-6 pt-10 pb-7 shadow-lg transition-all duration-300 hover:shadow-xl dark:border-gray-500 dark:bg-gray-900">
