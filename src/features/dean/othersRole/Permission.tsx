...
function Permission({
  ...
  return (
    <div
      onClick={handleClick}
      role="button"
      className={`flex w-66 cursor-pointer flex-col rounded-md px-4 py-3 ${choosenPermission.permission === permission.permission ? "ring-4" : "ring"} transition-colors ${isExist ? "bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-600 text-indigo-50 ring-gray-900/40" : "ring-gray-700/30 hover:bg-gray-100"} items-center justify-center gap-3`}
    >
