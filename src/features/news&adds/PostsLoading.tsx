      ...
      <div className="w-full animate-pulse rounded px-4 py-5 shadow md:px-6 md:py-7 dark:border-gray-400">
        <div className="mb-5 flex items-center">
          <svg
            ...
            aria-hidden="true"
            className="me-3 h-10 w-10 text-gray-400 dark:text-gray-600"
          >
          ...
          <div>
            <div className="mb-2 h-2.5 w-32 rounded-full bg-gray-400 dark:bg-gray-600"></div>
            <div className="h-2 w-24 rounded-full bg-gray-400 dark:bg-gray-600"></div>
          </div>
        </div>
        <div className="mb-5 h-2.5 w-48 rounded-full bg-gray-400 dark:bg-gray-600"></div>
        <div className="mb-2.5 h-2 rounded-full bg-gray-400 dark:bg-gray-600"></div>
        <div className="mb-2.5 h-2 rounded-full bg-gray-400 dark:bg-gray-600"></div>

        <div className="mb-5 h-2 rounded-full bg-gray-400 dark:bg-gray-600"></div>
        <div className="flex h-72 items-center justify-center rounded bg-gray-400 dark:bg-gray-600">
          <svg
            viewBox="0 0 16 20"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
